      ...
      <div id="culture">
        ...
        >
          ...
          >
            ...
            <h3 className=" mb-4">
              波普特廉价酒店是一家以提供经济实惠住宿为主打的酒店，位于帝都三环内的大学城附近。
            </h3>
            <h3 className=" mb-4">
              {" "}
              由于酒店的舒适住宿环境和相对较低的价格，吸引了广泛的客户群体，
            </h3>
            <h3 className=" mb-4">
              包括附近的学生、学生的亲属、旅行者和商务出差者等。
            </h3>
            <h3 className=" mb-4"> 酒店共有100间客房，分布在多层楼上，</h3>
            <h3 className=" mb-4">
              每间客房都配备了基本的设施，如床、浴室、电视以及新引入的自助中央温控系统。
            </h3>
          </div>
          <div style={{ flex: 1 }}>
            <Carousel />
                ...
                <div className="col mb-5">
                  <div className="card shadow-sm">
                    <div className="card-body px-4 py-5 px-md-5">
                      <div className="bs-icon-lg d-flex justify-content-center align-items-center mb-3 bs-icon"></div>
