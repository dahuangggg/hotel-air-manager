...
import { Container, Grid, Card, CardContent, Typography, ButtonGroup, Button, Divider, Box, FormControl, InputLabel, Select, MenuItem } from '@mui/material';
            ...
            <CardContent>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={6}>
                  ...
                  <Typography variant="h6" color={acStatus === 'On' ? 'primary' : 'error'}>
                    {acStatus}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
              ...
              <Box display="flex" flexDirection="column" alignItems="center">
                <ButtonGroup color="primary" aria-label="outlined primary button group" variant="outlined" style={{ margin: '10px 0' }}>
                  <Button onClick={decreaseTemperature}>-</Button>
                  <Button onClick={increaseTemperature}>+</Button>
                </ButtonGroup>
                <ButtonGroup color="primary" aria-label="outlined primary button group" variant="outlined" style={{ margin: '10px 0' }}>
                  <Button onClick={toggleAcStatus}>{acStatus === 'On' ? '关闭' : '打开'}</Button>
                </ButtonGroup>
              </Box>
            </CardContent>
          </Card>
