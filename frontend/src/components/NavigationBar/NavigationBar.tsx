          ...
          <Toolbar>
            ...
            <Box sx={{ flexGrow: 0, marginRight: 8 }}>
              <Typography variant="h6" component="div">
                <img src={"/BUPT.svg"} alt={"BUPT"} style={{ height: 40, width: 40, marginRight: 8 }} />
            ...
            <Box sx={{ flexGrow: 0 , marginRight: 8 }}>
              <Typography variant="h6" component="div">
                <Link to="/culture" className="nav-link" style={{ textDecoration: "none", color: "inherit" }}>
                  酒店文化
                </Link>
              </Typography>
            </Box>
            <Box sx={{ flexGrow: 0 , marginRight: 8 }}>
              <Typography variant="h6" component="div">
                <Link to="/customer" className="nav-link" style={{ textDecoration: "none", color: "inherit" }}>
                  顾客
                </Link>
              </Typography>
            </Box>
            <Box sx={{ flexGrow: 0 , marginRight: 8 }}>
              <Typography variant="h6" component="div">
                <Link to="/ac-manager" className="nav-link" style={{ textDecoration: "none", color: "inherit" }}>
                  管理
                </Link>
              </Typography>
            </Box>
            <Box sx={{ flexGrow: 0 , marginRight: 8 }}>
              <Typography variant="h6" component="div">
                <Link to="/reception" className="nav-link" style={{ textDecoration: "none", color: "inherit" }}>
                    前台
                </Link>
              </Typography>
            </Box>
            ...
            {isLoggedIn ? (
              ...
              <Select
                ...
                renderValue={(selected) => {
                  if (selected) {
                    return selected === 'customer' ? '顾客' :
                           selected === 'ac-manager' ? '管理' :
                           selected === 'room-manager' ? '前台' : '';
                  }
                  return '请先登录';
                }}
