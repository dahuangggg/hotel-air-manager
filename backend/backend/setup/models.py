...
class Settings(models.Model):
    ...
    # 模式
    mode = models.CharField(max_length=20, choices=MODE_CHOICES, default='1')
    ...
    low_speed_fee = models.FloatField(verbose_name="低速风费率 (元/1C°)", default=1)
    mid_speed_fee = models.FloatField(verbose_name="中速风费率 (元/1C°)", default=1)
    high_speed_fee = models.FloatField(verbose_name="高速风费率 (元/1C°)", default=1)